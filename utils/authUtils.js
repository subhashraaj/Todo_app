...
const sendVerificationMail = (email, verifiedToken) => {
    ...
    const transpoter = nodemailer.createTransport({
        ...
        service: "gmail",
        auth: {
            user: "subhashraaj0706@gmail.com",
            pass: "qjty yfrs nanj xyeq"
        }
    })

    //mailOptions
    const mailOptions = {
        from: "subhashraaj0706@gmail.com",
        to: email,
    ...
    transpoter.sendMail(mailOptions, function(error, info){
        if(error) {
            ...
            console.log(`Email has been sent sucessfully: ${email} ` + info.response)
        }
    })

}

module.exports = { userDataValidation, isEmailRegex, generateToken, sendVerificationMail }